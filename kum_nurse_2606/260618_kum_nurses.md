...
![bg left:48%](./images/title-ablelearn.png)
...
<div class="organization">AI전략 컨설턴트 | <div style="display: inline;">  <a href="http://w
ww.from-insight.com" target="_blank"> From Insight Inc. </a> </div>
...
<div>
  ...
  <summary>
  <span style="color:#f87ca1; font-size: 5em; font-weight: bold;">436 </span>
...
![alt text](../ai-agent/nhis-images/flows.png)
...
의뢰·회송 문서, 통계 보고서, 교육자료 자동화를 탭으로 시연하는 인터랙티브 페이지
...
<div class="card">
<b>리더의 원칙</b><br>
AI 활용의 책임은 AI가 아니라 조직과 사용자에게 있음 <br> "자동화"보다 "검토 가능한 보조"로 설계해야 함
</div>
